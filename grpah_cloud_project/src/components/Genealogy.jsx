...
const Genealogy = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('http://localhost:9000/genealogy/getAllPeople');
  ...
  const fetchMales = async () => {
    try {
      const response = await axios.get('http://localhost:9000/genealogy/getAllMales');
  ...
  const fetchFemales = async () => {
    try {
      const response = await axios.get('http://localhost:9000/genealogy/getAllFemales');
  ...
  const handleAddPerson = async () => {
    try {
      const response = await axios.post('http://localhost:9000/genealogy/addPerson', newPerson);
  ...
  const handleAddRelationship = async () => {
    try {
      const response = await axios.post('http://localhost:9000/genealogy/addParentChildRelationship', relationship);
      console.log(response.data);
  ...
  const handleAddMarriage = async () => {
    try {
      const response = await axios.post('http://localhost:9000/genealogy/addMarriageRelationship', relationship);
      console.log(response.data);
  ...
  const handleDeletePerson = async (personId) => {
    try {
      const response = await axios.delete(`http://localhost:9000/genealogy/deletePerson/${personId}`);
      console.log(response.data);
  ...
  const handleFetchUnmarriedPeople = async () => {
    try {
        const response = await axios.get('http://localhost:9000/genealogy/getUnmarriedPeople');
        console.log(response.data);
  ...
  const handleFetchMarriedPeople = async () => {
    try {
      const response = await axios.get('http://localhost:9000/genealogy/getMarriedPeople');
  ...
  const handleDeleteMarriage = async () => {
    try {
        const response = await axios.delete(`http://localhost:9000/genealogy/deleteMarriage/${relationship.spouse1Id}/${relationship.spouse2Id}`);
        console.log(response.data);
